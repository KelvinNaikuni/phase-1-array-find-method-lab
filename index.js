function superbowlWin(superbowlResults) {
  const winningResult = superbowlResults.find(result => result.result === "W");
  return winningResult ? winningResult.year : undefined;
}

// Example Super Bowl results
const superbowlResults = [
  ...
  // Add more Super Bowl results here
];

// Call the superbowlWin function with the example data
...
if (winningYear !== undefined) {
  ...
  console.log("No Super Bowl win found in the record.");
}
